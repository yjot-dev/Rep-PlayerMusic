package com.yjotdev.playermusic.presentation.navigation
...
import com.yjotdev.playermusic.presentation.mvvm.ui.AddPlayListView
import com.yjotdev.playermusic.presentation.mvvm.ui.ArtistListView
import com.yjotdev.playermusic.presentation.mvvm.ui.CurrentMusicView
import com.yjotdev.playermusic.presentation.mvvm.ui.CurrentPlayListView
import com.yjotdev.playermusic.presentation.mvvm.ui.MusicListView
import com.yjotdev.playermusic.presentation.mvvm.ui.PlayListView
import com.yjotdev.playermusic.presentation.mvvm.viewModel.UiViewModel
import com.yjotdev.playermusic.presentation.components.MyAlertDialog
import com.yjotdev.playermusic.presentation.components.ToolBarMenu
import com.yjotdev.playermusic.presentation.utils.Helper
import com.yjotdev.playermusic.domain.model.MusicListModel
import com.yjotdev.playermusic.R

@Composable
fun Navigation(
    vmPlayerMusic: UiViewModel,
    ...
    ObserveAlertDialogs(
        ...
        selectedPlaylist = selectedPlaylist ?: MusicListModel(),
...
private fun ObserveAlertDialogs(
    ...
    onSelectedPlayList: (MusicListModel) -> Unit,
    context: Context
){
    ...
    if(removePlaylist){
        MyAlertDialog(
            ...
            confirmClicked = {
                ...
                onPlaylistName("")
                onSelectedPlayList(MusicListModel())
            },
            dismissClicked = {
                onRemovePlaylist(false)
                onPlaylistName("")
